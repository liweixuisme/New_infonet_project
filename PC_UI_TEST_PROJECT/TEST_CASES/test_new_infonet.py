...
from BUSINESSVIEWS.new_infonet_login_businessview import *
from BUSINESSVIEWS.new_infonet_register_user_businessview import *
from BUSINESSVIEWS.new_infonet_usercenter_businessview import *
import GL
...
class Test_case(unittest.TestCase):
    ...
    def test_new_infonet_register_jobseeker(self):
        L = New_InfoNet_RegisterUserBusinessview(self.driver)
        url = "http://infonet.new.bringbuys.com/login?lang=zht"
        L.get_url(url)
        L.maximize_window()
        dict={
        ...
        L.registerGetInto(**dict)
        L.registerJobSeekerGetInto(**dict)
    ...
    def test_new_infonet_upload_jobseeker_info(self):
        ...
        L.get_url(url)
        L.maximize_window()
        L.registerGetInto("register_page")
        strTime = int(time.time())
        L.registerJobSeekerGetInto("register_page")
        var_job_seeker_name = "LW_font_register_jobseeker" + str(strTime)
        L.registerJobseeker(var_job_seeker_name, "2321628281@qq.com", "fanxiangyunjisuanhahaha","abc123456", "register_page")
        L = New_info_net_login_businessview(self.driver)
    ...
    def test_new_infonet_upload_foodsupplier_info(self):
        ...
        L.registerGetInto("register_page")
        strTime = int(time.time())
        L.registerSupplierGetInto("register_page")
        var_foodsupplier_name = "LW_font_register_foodsupplier" + str(strTime)
        L.registerSupplier(var_foodsupplier_name,"390485519@qq.com",var_foodsupplier_name+"_company","food_supplier","fanxiangyunjisuanhahaha","abc123456", "register_page")
        L = New_info_net_login_businessview(self.driver)
        L.new_info_net_goto_login("login_page")
    ...
    def test_new_infonet_upload_servicesupplier_info(self):
        ...
        strTime = int(time.time())
        L.registerSupplierGetInto("register_page")
        var_service_supplier_name = "LW_font_register_foodsupplier" + str(strTime)
        L.registerSupplier(var_service_supplier_name,"13229794612@163.com",var_service_supplier_name+"_company","service_supplier","fanxiangyunjisuanhahaha","abc123456", "register_page")
        L = New_info_net_login_businessview(self.driver)
        L.new_info_net_goto_login("login_page")
